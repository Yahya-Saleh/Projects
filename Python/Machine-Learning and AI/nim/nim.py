...
class NimAI:
    ...
    def best_future_reward(self, state):
        ...
        if actions:
            # Return the highest q value of all of the possible actions
            return max([self.get_q_value(state, action) for action in actions])

        # Return 0 if no possible actions
        return 0
    ...
    def best_action(self, state):
        ...
        for action in actions:
            ...
            # If we found an action with the best score
            if best_q == 1:
                return best_action

            elif best_q < self.get_q_value(state, action):
                best_action = action
