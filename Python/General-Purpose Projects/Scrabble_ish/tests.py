...
def test_calculateHandlen():
    ...
    # Test 1
    hand = {"a": 1, "b": 2, "c": 3}
    if calculateHandlen(hand) != 6:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 6 with hand ", hand)

        failure = True

    # Test 2
    hand = {"a": 1, "b": 1, "c": 1}
    if calculateHandlen(hand) != 3:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 3 with hand ", hand)

        failure = True

    # Test 3
    hand = {"a": 1, "b": 1, "c": 1, "d": 3}
    if calculateHandlen(hand) != 6:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 6 with hand ", hand)
...
print("----------------------------------------------------------------------")
print("Testing test_calculateHandlen...")
